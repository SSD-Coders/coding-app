...
public class Courses {
    ...
    public Courses(String title, String course_level, String description, String image, String courseLink) throws Exception {
        this.title = title;
    ...
    public String toString() {
        return "Courses{" + "title='" + title + '\'' + ", description='" + description + '\'' + ", image='" + image + '\'' + ", courseLink='" + courseLink
                + '\'' + '}';
    }
}
